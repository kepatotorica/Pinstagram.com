...
echo "asdfasdfasdafd";
  // $fileUser = $file['pic_user_id']; // should be based on session
   ...
   echo "pic id= " . $_SESSION['currPic']."<br> title= ". $imgTitle."<br> address= ". $imgAdd."<br> description= ". $imgDesc;
   // $dao->saveImg($imgTitle,$imgUserId,$imgAdd,$imgDesc,$fileDestination);
    $dao->updateImg($_SESSION['currPic'], $imgTitle, $imgAdd, $imgDesc);
    header("Location: home.php?editsuccess" .".". $imgTitle .".". $imgAdd . ".".$imgDesc );
