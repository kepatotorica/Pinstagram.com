...
<!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script> -->
              ...
              <?php
              // <label for="title"><pre>'. print_r($picture,1) .'</pre></label>
                    echo '<div><input type="text" class="text_box" name="title" placeholder="title" onkeypress="return isNumberKey(event)" maxlength="100" required="required" title="max length of 100 characters" value="'.htmlspecialchars($picture[0]['pic_title']).'"></div>
                          <input id="locationTextField" type="text" class="text_box" name="address" onkeypress="return isNumberKey(event)" maxlength="255" required="required" title="max length of 255 characters" value="'.htmlspecialchars($picture[0]['pic_address']).'">
                          <textarea rows="4" cols="30" class="text_box" name="description" placeholder="description" onkeypress="return isNumberKey(event)" maxlength="255" required="required" title="max length of 255 characters" value="'.htmlspecialchars($picture[0]['pic_desc']) .'">'.htmlspecialchars($picture[0]['pic_desc']).'</textarea>';
              ?>
